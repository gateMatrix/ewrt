...
echo "<td> <a href='district-incident-report.php?id=".$row['incidentID']."&loc=".$row['parish']."&monitor=".$row['monitor']."&off=".$row['closingOfficer']."' type='button' class='btn btn-theme btn-sm'>View Details</a></td>";
echo "</tr>";
}
?>
