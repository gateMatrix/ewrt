...
$sql = "UPDATE incident SET name='$name', incidentType='$incidentType', parish='$parish', severity='$severity', injured='$injured', fatalities='$fatalities', perpetrators='$perpetrators' WHERE incidentID='$incident' ";
...
<?php
$incident = $_GET['id'];
$sqlw = "SELECT * FROM incident WHERE incidentID='$incident' ";
...
?>
	<div class="form-group mb-3">
			...
			<textarea name="name" class="form-control" id="exampleFormControlTextarea1" rows="3"><?php echo $roww['name']; ?></textarea>
	</div>
...
<div class="col-md-6">
	<div class="mb-3">
		...
		<input type="text" name="date" value="<?php echo $roww['date1']; ?>" class="form-control" id="datepicker-default" placeholder="yyyy-mm-dd">
	</div>
</div>
<div class="col-md-6">
	<div class="mb-3">
    ...
    <select class="form-select" name="perpetrators" id="example-select" class="choices form-select">
    	<option><?php echo $roww['perpetrators']; ?></option>
        <?php 
...
<div class="mb-3">
    ...
    <select class="form-select" id="example-select" class="choices form-select" name="incidentType">
    	<option><?php echo $roww['incidentType']; ?></option>
        <?php 
...
<div class="mb-3">
    ...
    <select class="form-select" id="example-select" class="choices form-select" name="severity">
    	<option><?php echo $roww['severity']; ?></option>
        <?php 
...
<div class="form-group mb-3">
	...
	<input type="number" value="<?php echo $roww['injured']; ?>" name="injured" class="form-control" placeholder="Cases that result into death">
</div>
</div>
<div class="col-md-6">
<div class="form-group mb-3">
	<label class="form-label" for="exampleFormControlInput1">Number of Fatalities</label>
	<input type="number" value="<?php echo $roww['fatalities']; ?>" name="fatalities" class="form-control">
</div>
</div>
</div>
...
<div class="form-group mb-3">
	<button type="submit" name="update" class="btn btn-theme btn">Update Incident</button>
</div>
