...
$name = $_POST["name"];
$sql = "INSERT INTO indicators (name) VALUES ('$name')";
...
<a onclick='return checkDelete()' href='includes/delete.php?id=".$row['qtnID']."&t=".$tableName."&tID=".$tableid."' aria-label='anchor' class='btn btn-sm bg-danger-subtle' data-bs-toggle='tooltip' data-bs-original-title='Delete'>
...
<input type="text" placeholder="Enter indicator name" class="form-control" name="name" >
</div>
...
<button type="submit" name="register" class="btn btn-theme btn">Add Indicator</button>
</div>
</form>
	</div>
</div>
