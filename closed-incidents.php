...
echo "<td> <a href='incident-report.php?id=".$row['incidentID']."&loc=".$row['parish']."&monitor=".$row['monitor']."&off=".$row['closingOfficer']."' type='button' class='btn btn-theme btn-sm'>Generate Report</a></td>";
echo "</tr>";
}
?>
