...
<?php if ($row['risk'] == 1) {
// code...
echo "<a href='risk-indicator.php?id=".$row['incidentID']." type='button' class='btn btn-theme btn-sm'>Add Response Indicators</a>";
}elseif ($row['risk'] == 0) {
// code...
echo "<a href='#' data-bs-toggle='tooltip' data-bs-original-title='Complete the risk indicators section first!' type='button' class='btn btn-theme btn-sm'>Add Response Indicators </a>";
} ?> 
