...
$userid = $_SESSION['id'];
$sql = "SELECT incident.incidentID, incident.incidentType, incident.severity, incident.date1, incident.status, incident.evidence   FROM incident WHERE monitor='$userid' ORDER BY ID DESC";
