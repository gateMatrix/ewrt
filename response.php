	...
	<div class="row">
		...
		<div class="col-xl-12">
			...
			<h1 class="page-header">
				Incident #CAF263 <br/><small>Monitoring the responses of local authorities, peacekeepers, and humanitarian actors.</small>
			</h1>
					...
					<div class="card-body pb-2">
						<form>
							<div class="row">
									...
									<div class="form-group mb-3">
										<button type="button" class="btn btn-theme btn">Small button</button>
									</div>
